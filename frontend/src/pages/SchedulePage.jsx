          ...
          >
            ...
            {count > 0 && (
              <span className={`ml-2 text-xs px-2 py-1 rounded-full ${
                view === id ? "bg-white/20" : "bg-blue-100 text-blue-600"
              }`}>
                {count}
              </span>
            )}
...
function TaskCard({ task, onClick, isToday = false }) {
  ...
  return (
    <div
      className={`p-4 rounded-xl border-2 cursor-pointer transition-all duration-200 hover:scale-102 hover:shadow-md ${
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-7 gap-4">
                {(() => {
                  ...
                  return days.map((day, index) => {
                    ...
                    return (
                      <div key={day} className={`p-4 rounded-xl border-2 transition-colors ${
                        isToday ? 'border-blue-300 bg-blue-50' : 'border-gray-200 bg-gray-50 hover:bg-gray-100'
                      }`}>
            ...
            <div className="space-y-6">
              {(() => {
                ...
                return days.map((day, index) => {
                  ...
                  return (
                    <div key={day} className={`rounded-xl border-2 p-6 transition-all duration-200 ${
                      isToday ? 'border-blue-300 bg-blue-50 shadow-lg' : 'border-gray-200 bg-white hover:shadow-md'
                    }`}>
                      <div className="flex items-center justify-between mb-4">
                        <div>
