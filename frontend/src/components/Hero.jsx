export default function Hero({ userName = "User", todayTasks = 0, completedTasks = 0 }) {
  ...
  return (
    <section className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700 text-white p-6 md:p-8 lg:p-12 rounded-xl shadow-lg mb-8 relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between">
          <div className="flex-1">
            ...
            <p className="text-sm sm:text-md md:text-lg text-blue-100 mb-4 max-w-2xl">
