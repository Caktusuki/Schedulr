  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col items-center">
      ...
      <section className="w-full bg-blue-600 text-white text-center py-20 rounded-2xl shadow-md">
        ...
        <Link
          to="/Calendar"
          className="bg-white dark:bg-gray-800 text-blue-600 font-semibold px-6 py-3 rounded-lg shadow-md hover:bg-blue-50 dark:hover:bg-blue-900 transition"
        >
          Get Started
        </Link>
      </section>
      ...
      <div className="max-w-5xl w-full px-6 py-16 space-y-12">
        ...
        {/* Footer section */}
        <footer className="bg-indigo-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 py-10 mt-16">
